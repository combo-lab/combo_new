defmodule ComboLite.UserWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :combo_lite
  ...
  @socket_partitions_options if(Application.compile_env(:combo_lite, :process_limit),
                               do: [partitions: 2],
                               else: []
                             )
  ...
  plug Plug.Static,
    at: "/",
    from: {:combo_lite, "priv/user_web/static"},
    gzip: false,
    only: ComboLite.UserWeb.static_paths()
