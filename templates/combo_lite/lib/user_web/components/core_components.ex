...
defmodule ComboLite.UserWeb.CoreComponents do
  @moduledoc """
  ...
  use ComboLite.UserWeb, :component
  import ComboLite.UserWeb.BaseComponents, only: [icon: 1]
  ...
  def modal(assigns) do
    ...
    >
      <div id={"#{@id}-bg"} class="bg-base-50/90 fixed inset-0 transition-opacity" aria-hidden="true" />
      <div
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-base-700/10 ring-base-700/10 relative hidden rounded-2xl bg-white p-14 shadow-lg ring-1 transition"
            >
  ...
  def flash_group(assigns) do
    ...
    <div id={@id} class="fixed top-4 right-4 z-50 space-y-3">
      ...
      <.flash
        id="client-error"
        kind={:error}
        title={dgettext("ui", "We can't find the internet")}
      ...
      <.flash
        id="server-error"
        kind={:error}
        title={dgettext("ui", "Something went wrong!")}
    ...
    <div>
      <label class="flex items-center gap-4 text-sm leading-6 text-base-600">
        ...
        <input
          ...
          value="true"
          checked={@checked}
          class="rounded border-base-300 text-base-900 focus:ring-0"
          {@rest}
        />
        <%= @label %>
      </label>
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-gray-300 bg-white shadow-sm focus:border-base-400 focus:ring-0 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg text-base-900 focus:ring-0 sm:text-sm sm:leading-6 min-h-[6rem]",
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ComboLite.I18n.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ComboLite.I18n.Gettext, "errors", msg, opts)
    end
  end
