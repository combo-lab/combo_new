...
defmodule ComboDesktop.UserWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ComboDesktop.I18n.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ComboDesktop.I18n.Gettext, "errors", msg, opts)
    end
  end
