...
config :combo_desktop, :dns_cluster_query, CozyEnv.get_env("DNS_CLUSTER_QUERY")
...
if CozyEnv.get_env("RELEASE_NAME") || CozyEnv.get_env("COZY_PROXY_SERVER") do
  config :combo_desktop, CozyProxy, server: true
end
...
config :combo_desktop, ComboDesktop.UserWeb.Endpoint, url: cozy_proxy_parsed_endpoint
