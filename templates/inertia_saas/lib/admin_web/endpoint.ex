defmodule InertiaSaaS.AdminWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_inertia_saas_admin_web_key",
  ...
  plug Plug.Static,
    at: "/",
    from: {:inertia_saas, "priv/admin_web/static"},
    gzip: false,
    only: InertiaSaaS.AdminWeb.static_paths()
  ...
  plug InertiaSaaS.AdminWeb.Router
end
