defmodule NeedleCombo.AdminWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeedleCombo.I18n.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeedleCombo.I18n.Gettext, "errors", msg, opts)
    end
  end
