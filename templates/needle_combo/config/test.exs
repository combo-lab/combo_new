...
config :needle_combo, NeedleCombo.Core.Repo,
  ...
  password: "postgres",
  hostname: "localhost",
  database: "needle_combo_core_test#{System.get_env("NEEDLE_COMBO_CORE_MIX_TEST_PARTITION")}",
...
config :needle_combo, NeedleCombo.Core.Mailer, adapter: Swoosh.Adapters.Test
