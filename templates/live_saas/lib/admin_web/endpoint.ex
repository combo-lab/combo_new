defmodule LiveSaaS.AdminWeb.Endpoint do
  ...
  plug Plug.Static,
    at: "/",
    from: {:live_saas, "priv/admin_web/static"},
    gzip: false,
    only: LiveSaaS.AdminWeb.static_paths()
